...
class TestNASIntegration:
    ...
    def test_nas_playlist_directory_move(self, nas_test_path: Path):
        ...
        try:
            ...
            success = downloader._move_playlist_to_final_destination(playlist_dir, nas_dest)
    ...
    def test_nas_concurrent_operations(self, nas_test_path: Path):
        ...
        def worker(worker_id: int):
            ...
            try:
                # Create temp file
                with tempfile.NamedTemporaryFile(delete=False, suffix=f'_{worker_id}.mp4') as temp_file:
    ...
    def test_nas_error_handling(self, nas_test_path: Path):
        ...
        success = downloader._move_file_to_final_destination(non_existent_file, nas_dest)
        ...
        try:
            ...
            success = downloader._move_file_to_final_destination(temp_file, invalid_dest)
            assert success == False

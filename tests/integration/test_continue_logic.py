...
class TestContinueLogic:
    ...
    def test_get_playlist_progress(self):
        ...
        with patch('modules.video.services.download_service.VideoDownloadService') as mock_service_class:
    ...
    def test_continue_download_default_true(self):
        ...
        with patch('modules.video.services.download_service.VideoDownloadService') as mock_service_class:
            ...
            def mock_download_playlist_with_transcription(url, output_path=None, continue_download=True, **kwargs):
                return {"success": True}
            
            mock_downloader.download_playlist_with_transcription = mock_download_playlist_with_transcription
            mock_service_class.return_value = mock_downloader
            
            # Check method signature has continue_download=True by default
            import inspect
            sig = inspect.signature(mock_downloader.download_playlist_with_transcription)

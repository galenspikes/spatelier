...
@pytest.fixture
def nas_test_directory(nas_test_path: Path, nas_available: bool) -> Generator[Path, None, None]:
...
def nas_test_data():
    ...
    return {
        "video_files": [
            {"name": "test_video_1.mp4", "size": 1024 * 1024, "content": b'\x00' * (1024 * 1024)},
            {"name": "test_video_2.mp4", "size": 5 * 1024 * 1024, "content": b'\x00' * (5 * 1024 * 1024)},
            {"name": "test_video_3.mp4", "size": 10 * 1024 * 1024, "content": b'\x00' * (10 * 1024 * 1024)}
        ],
        "audio_files": [
            {"name": "test_audio_1.mp3", "size": 512 * 1024, "content": b'\x00' * (512 * 1024)},
            {"name": "test_audio_2.wav", "size": 2 * 1024 * 1024, "content": b'\x00' * (2 * 1024 * 1024)}
        ],
        "subtitle_files": [
            {"name": "test_subtitles.srt", "size": 1024, "content": "1\n00:00:00,000 --> 00:00:05,000\nTest subtitle\n"},
            {"name": "test_subtitles.vtt", "size": 1024, "content": "WEBVTT\n\n00:00:00.000 --> 00:00:05.000\nTest subtitle\n"}
        ]
    }

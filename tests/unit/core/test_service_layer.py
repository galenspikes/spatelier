...
from core.interfaces import (
    IDatabaseService, IRepositoryContainer, IVideoDownloadService,
    IMetadataService, ITranscriptionService, IPlaylistService
)
...
class TestServiceFactory:
    ...
    def test_create_transcription_service(self):
        ...
        with patch('modules.video.services.transcription_service.TranscriptionService') as mock_service:
            with patch.object(factory, 'create_database_service', return_value=Mock()):

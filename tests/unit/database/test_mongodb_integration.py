...
class TestMongoDBIntegration:
    ...
    def test_store_transcription_with_non_numeric_string_id(self, transcription_storage):
    ...
    def test_transcription_data_consistency(self, transcription_storage):
        ...
        call_args = transcription_storage.collection.insert_one.call_args[0][0]
        expected_fields = [
            "video_id", "created_at", "segments", "language", 
            "language_probability", "duration", "model_used", 
            "processing_time", "total_segments", "full_text"
        ]
    ...
    def test_transcription_storage_error_handling(self, transcription_storage):
        ...
        transcription_storage.collection.insert_one.side_effect = Exception("MongoDB error")
    ...
    def test_transcription_retrieval_error_handling(self, transcription_storage):
        ...
        transcription_storage.collection.find_one.side_effect = Exception("MongoDB error")

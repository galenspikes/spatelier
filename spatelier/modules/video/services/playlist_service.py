...
from spatelier.core.base_service import BaseService
from spatelier.core.config import Config
from spatelier.core.interfaces import IPlaylistService
from spatelier.infrastructure.storage import NASStorageAdapter, StorageAdapter
from spatelier.utils.cookie_manager import CookieManager
from spatelier.utils.helpers import YOUTUBE_VIDEO_ID_FILENAME_PATTERN
            ...
            if downloaded_videos:
                ...
                for position, video_path in enumerate(downloaded_videos, 1):
                    try:
                        ...
                        from spatelier.utils.helpers import get_file_hash, get_file_type
